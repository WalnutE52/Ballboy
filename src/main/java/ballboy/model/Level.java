...
public interface Level {
    ...
    /**
     * The current x position of the hero. This is useful for views so they can
     * follow the hero.
     *
    ...
    /**
     * The current y position of the hero. This is useful for views so they can
     * follow the hero.
     *
    ...
    /**
     * Increase the height the bouncing hero can reach. This could be the vertical
     * acceleration of the hero, unless the current level has special behaviour.
     *
    ...
    /**
     * Reduce the height the bouncing hero can reach. This could be the vertical
     * acceleration of the hero, unless the current level has special behaviour.
     *
     * @return true if successful
     */
    ...
    /**
     * Move the hero left or accelerate the hero left, depending on the current
     * level's desired behaviour
     *
     * @return true if successful
     */
    boolean moveLeft();
    ...
    /**
     * Move the hero right or accelerate the hero right, depending on the current
     * level's desired behaviour
     *
     * @return true if successful
     */
    ...
    boolean ifEnemy(Entity a);

    void killEnemy(DynamicEntity a);
    ...
    MementoOneLevel saveLevel();

    void loadLevel(MementoOneLevel mementoOneLevel);
