...
public abstract class DynamicEntity implements Entity {
    ...
    /**
     * @param entity The entity that this entity has collided with. This method is
     *               responsible for any entity-specific behaviour.
     */
    ...
    /**
     * @return Vector2 The previous top left anchor position prior to the last
     *         update.
     */
    ...
    /**
     * @return double The current entity's horizontal acceleration relative to
     *         ground.
     */
    public abstract double getHorizontalAcceleration();

    /**
     * @param horizontalAcceleration The new horizontal acceleration to be applied
     *                               to the entity.
     */
