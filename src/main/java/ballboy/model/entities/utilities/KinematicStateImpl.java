...
public class KinematicStateImpl implements KinematicState {
    ...
    private KinematicStateImpl(Vector2D position, Vector2D velocity, double horizontalAcceleration) {
    ...
    private KinematicStateImpl(Vector2D position, Vector2D previousPosition, Vector2D velocity,
    ...
    @Override
    public void update(double milliSeconds, double levelGravity) {
        this.previousPosition = position;
    ...
    public KinematicState copy() {
        return new KinematicStateImpl(this.position, this.previousPosition, this.velocity, this.horizontalAcceleration);
    }
    ...
    public static class KinematicStateBuilder {
        ...
        public KinematicStateImpl build() {
            return new KinematicStateImpl(this.position, this.velocity, 0);
        }
    }
}
