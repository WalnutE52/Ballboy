...
public class StaticEntityImpl extends StaticEntity {
    ...
    public StaticEntityImpl(AxisAlignedBoundingBox volume, Entity.Layer layer, Image image) {
        this.volume = volume;
        this.layer = layer;
        this.image = image;
    }
    ...
    public Entity copy() {
        ...
        StaticEntityImpl staticentity = new StaticEntityImpl(this.volume.copy(), this.layer, this.image);
        return staticentity;
    }
