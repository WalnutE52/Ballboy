...
/**
 * A scared behaviour strategy that makes the entity follow accelerate away from
 * the ballboy if within a threshold distance. A velocity cap is also applied to
 * keep the velocity within a reasonable threshold.
 */
