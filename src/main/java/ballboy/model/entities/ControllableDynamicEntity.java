...
public class ControllableDynamicEntity<T extends DynamicEntity> extends DynamicEntity {
    ...
    public ControllableDynamicEntity(T entity, Vector2D startingPosition, double maxHorizontalVelocity,
            double floorHeight, double gravity) {
        this.entity = entity;
    ...
    public ControllableDynamicEntity<DynamicEntity> copy() {
        ...
        ControllableDynamicEntity<DynamicEntity> hero = new ControllableDynamicEntity<DynamicEntity>(
                (DynamicEntity) this.entity.copy(), this.startingPosition.copy(), this.maxHorizontalVelocity,
                this.floorHeight, this.gravity);
        return hero;
    }
    ...
    /**
     * Sets the vertical velocity of the current entity to a value that will
     * increase its vertical bounce height relative to the floor by a fixed amount.
     *
    ...
    public boolean boostHeight() {
        ...
        /*
         * NaN in the instance when the equation doesn't have a real solution. This will
         * occur if the entity is within epsilon of the max height (level height)
         */
    ...
    /**
     * Sets the vertical velocity of the current entity to a value that decreases
     * the current bounce height by a fixed value.
     *
     * @return boolean True if the bounce height of the current entity was
    ...
    /**
     * Applies a horizontal acceleration in the left direction until a maximum
     * velocity is reached.
     *
    ...
    /**
     * Applies a horizontal acceleration in the right direction until a maximum
     * velocity is reached.
     *
    ...
    /**
     * Resets the current state to its state when the current instance was
     * instantiated. The entity is moved back to its starting position, and the
     * control inputs are reset.
     *
     ...
     */
    @Override
    public void update(double durationNano, double levelGravity) {
    ...
    /**
     * Enforces the current horizontal velocity limits. If the limit is exceeded,
     * horizontal acceleration of the wrapped entity is set to 0.
     */
