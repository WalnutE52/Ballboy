...
public class DynamicEntityImpl extends DynamicEntity {
    ...
    public DynamicEntityImpl(KinematicState kinematicState, AxisAlignedBoundingBox volume, Layer layer, Image image,
            CollisionStrategy collisionStrategy, BehaviourStrategy behaviourStrategy) {
    ...
    public Entity copy() {
        ...
        DynamicEntityImpl dynamic = new DynamicEntityImpl(this.kinematicState.copy(), this.volume.copy(), this.layer,
                this.image, this.collisionStrategy, this.behaviourStrategy);
        return dynamic;
    }
