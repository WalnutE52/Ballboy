...
public interface Entity {
    /**
     * Returns the current Image used by this Entity. This may change over time,
     * such as for simple animations.
     *
    ...
    /**
     * @return Vector2 The current position of the entity, being the top left
     *         anchor.
     */
    ...
    /**
     * Returns the current 'z' position to draw this entity. Order within each layer
     * is undefined.
     *
