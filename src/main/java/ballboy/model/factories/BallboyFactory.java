...
public class BallboyFactory implements EntityFactory {
    ...
    public Entity createEntity(Level level, JSONObject config) {
        try {
            ...
            return new DynamicEntityImpl(kinematicState, volume, Entity.Layer.FOREGROUND, new Image(imageName),
                    new BallboyCollisionStrategy(level), new PassiveEntityBehaviourStrategy());
