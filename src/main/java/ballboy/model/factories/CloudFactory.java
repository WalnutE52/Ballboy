        ...
        public Entity createEntity(Level level, JSONObject config) {
                try {
                        ...
                        KinematicState kinematicState = new KinematicStateImpl.KinematicStateBuilder()
                                        .setPosition(startingPosition).setHorizontalVelocity(xVelocity).build();
                        ...
                        return new DynamicEntityImpl(kinematicState, volume, Entity.Layer.BACKGROUND,
                                        new Image(imageName), new PassiveCollisionStrategy(),
