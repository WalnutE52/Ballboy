...
public interface PhysicsEngine {
        ...
        /**
         * Resolves a collision between two dynamic entities, conserving their current
         * momentum.
         *
        ...
        /**
         * Enforces level boundaries on the provided dynamic entity. When the dynamic
         * entity is outside the level bounds, it will be redirected.
         *
